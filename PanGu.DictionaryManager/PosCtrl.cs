    ...
    public partial class PosCtrl : UserControl
    {
        ...
        private void CreatePosCheckBox()
        {
            ...
            for (int i = 0; i < 31; i++)
            {
                ...
                checkBoxPos.CheckedChanged += new EventHandler(this.checkBox_CheckedChanged);
                this.m_PosTable[tPos] = checkBoxPos;
        ...
        private void checkBox_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (checkBox.Checked)
            {
                ...
                CheckBox posCheckBox = (CheckBox)this.m_PosTable[(POS)0];

                if ((POS)checkBox.Tag == POS.POS_UNK)
                {
                    foreach (object key in this.m_PosTable.Keys)
                    {
                        posCheckBox = (CheckBox)this.m_PosTable[key];
        ...
        private void RefreshPos()
        {
            ...
            posCheckBox = (CheckBox)this.m_PosTable[(POS)0];
            this.m_Pos = 0;
            ...
            {
                POS tPos = (POS)pos;
                posCheckBox = (CheckBox)this.m_PosTable[tPos];
